...
public class QuantityMeasurementApp {
    ...
    */
    ...
    public static Length demonstrateLengthAddition(Length length1, Length length2,LengthUnit unit) {
    	if(length1 == null || length2 == null) {
